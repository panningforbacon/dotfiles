...
## CONSIDER THIS TOO: https://www.hexnode.com/mobile-device-management/help/script-to-customize-finder-preferences-on-mac/
...
# Install the Solarized Dark theme for iTerm 2
open "${HOME}/init/Solarized Dark.itermcolors"

# Don’t display the annoying prompt when quitting iTerm 2
...
echo "All done with macOS settings. 👏"